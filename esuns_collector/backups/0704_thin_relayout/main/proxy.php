 ...
 */
//$proxy = new AjaxProxy('http://localhost:5656');//筆電開發
$proxy = new AjaxProxy('http://192.168.1.163:5656');//登陽server
//$proxy = new AjaxProxy('http://421a2891.ngrok.io');//登陽server (ngrok)
$proxy->execute();
